...
BEGIN_MESSAGE_MAP(CSlidingPuzzleApp, CWinAppEx)
...
BOOL CSlidingPuzzleApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSlidingPuzzleDoc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CSlidingPuzzleView));
	if (!pDocTemplate)
		return FALSE;
...
void CSlidingPuzzleApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CSlidingPuzzleApp::LoadCustomState()
{
}

void CSlidingPuzzleApp::SaveCustomState()
{
}
